...
public class FirebaseHelperInbox {

    DatabaseReference db;
    Boolean saved=null;
    ArrayList<MyInbox> myInboxes=new ArrayList<>();

    public FirebaseHelperInbox(DatabaseReference db) {
...
//    }
    ...
    //READ
    public ArrayList<MyInbox> retrieve()
    {
